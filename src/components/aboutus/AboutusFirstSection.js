...
import img4 from "../../images/square-blue.png"
import img5 from "../../images/square-dots-orange.png"
            ...
            <div className='row justify-content-center'>
                <div className='col-lg-6 first-col'>
                    <div className='imgs-side'>
                        <ul>
                            <li className='mb-4 d-flex'><img src={pic1} alt="pic-1" /></li>
                            <li className='mb-4 d-flex'><img src={pic2} alt="pic-2" /></li>
                            <li className='mb-4 d-flex'><img src={pic3} alt="pic-3" /></li>
                            <li className='mb-4 d-flex'>20 <span>Years Experience</span></li>
                        </ul>
                    </div>
                </div>
                <div className='col-lg-6'>
                  <div className="second-col">
                    ...
                    <div className='row svg-side mb-4'>
                        ...
                        <div className='col-lg-6 col-sm-6 mb-30 mb-sm-20 mb-3'>
                            <div  className='feature2  d-flex align-items-center'>
                                <div className='icon'>
                    ...
                    <button type="button" className='btn contact-btn'>Contact Us</button>
                  </div>
                </div>
            </div>
